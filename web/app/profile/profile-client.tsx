  ...
  return (
    <div className="pb-4">
      ...
      <div className="grid grid-cols-4 gap-2 px-4 py-3 border-b border-gray-100">
        {[
          { icon: BookOpen, label: '选校清单', color: 'bg-blue-50 text-blue-500', href: '/explore' },
          { icon: Heart, label: '我的收藏', color: 'bg-rose-50 text-rose-500', href: '#' },
          { icon: FileText, label: '文书草稿', color: 'bg-purple-50 text-purple-500', href: '#' },
          { icon: Plus, label: '分享案例', color: 'bg-orange-50 text-[#FF6A00]', href: '/cases/new' },
          ...
          <>
            {myCases.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                ...
                <Link href="/cases/new" className="bg-[#FF6A00] text-white text-xs px-4 py-2 rounded-full font-medium">
                  分享我的申请经历
                </Link>
              </div>
            )}
          ...
          <>
            {favorites.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                ...
                <Link href="/explore" className="bg-[#FF6A00] text-white text-xs px-4 py-2 rounded-full font-medium">
                  去探索院校
                </Link>
              </div>
            )}
