    ...
    <form onSubmit={handleSubmit} className="mt-3">
      ...
      <div className="flex gap-2">
        <textarea
          ...
          className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-[#FF6A00] transition-colors resize-none"
        />
        <button
          type="submit"
          disabled={isPending || !content.trim()}
          className="w-10 h-10 bg-[#FF6A00] rounded-xl flex items-center justify-center flex-shrink-0 self-end disabled:opacity-50"
        >
